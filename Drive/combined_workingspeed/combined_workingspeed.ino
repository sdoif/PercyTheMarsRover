...
float vpd,vb,vref,vrefe,iL,dutyref,current_mA; // Measurement Variables
...
//    DIRLstate = LOW;
  ...
  Serial.println("vrefe=" +String(vrefe));
...
void sampling(){
  ...
  //vrefe = sensorValue2 * (4.096 / 1023.0);// Convert the Vref sensor reading to volts
  //vrefe=3.5;
  vref=1.55;
  vpd = sensorValue3 * (4.096 / 1023.0); // Convert the Vpd sensor reading to volts
//  if(counter_void<300){
//  vref = counter_void/100;
//  }else{
//    vref = 3;
//  }
  
  //MovingAverage<float> vrefaverage(20, 0);
  //if(vref!=vrefe){
  //    for(int i = 0; i<=19; i++){
  //      for(int j = 0; j<=10; j++){
         // Serial.println("jaaa=" +String(j));
 //  if(j>=10){
 //   vref = vrefaverage.push(vrefe).get();
        //Serial.println("Loopvref=" +String(vref));
 //   j=0;
 //   }
    //Serial.println("loopvref= " +String(vref));
 //   }
