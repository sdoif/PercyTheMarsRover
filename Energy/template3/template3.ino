...
//    }if(Vbat4 < 3.7){
//      if(Vbat4 < 3.17341){
//        soc_bat4 = 5.791*Vbat4 - 14.449;
//      } else if(Vbat4 < 3.28091){
//        soc_bat4 = 38.18865*Vbat4 - 117.2603;
//      } else if(Vbat4 < 3.29271){
//        soc_bat4 = 641.9322*Vbat4 - 2098.08857;
//      } else if(Vbat4 < 3.3285){
//        soc_bat4 = 211.8916*Vbat4 - 682.0896;
//      } else if(Vbat4 < 3.36031){
//        soc_bat4 = 297.4945*Vbat4 - 967.0188;
//      } else if(Vbat4 < 3.38417){
//        soc_bat4 = 1166.492*Vbat4 - 3887.1198;
//      } else if(Vbat4 < 3.44382){
//        soc_bat4 = 522.233*Vbat4 - 1706.83785;
//      } else if(Vbat4 < 3.59494){
//        soc_bat4 = 54.6433*Vbat4 - 96.543;
//      }
//    } else if(Vbat4 > 3.7){
//      next_state = 5;
//    }
  ...
  {
    if(soc_bat1 < 100){
    soc_bat1 = soc_bat1 + (current_measure/(500*3600));
    } else {
      voltage_check = 10000;
      if(Vbat1 < 3.28078){
        soc_bat1 = 12.915*Vbat1 - 34.9624;
    ...
    soc_bat2 = soc_bat2 + (current_measure/(500*3600));
    } else {
      voltage_check = 10000;
      if(Vbat2 < 3.27282){
        soc_bat2 = 12.3879*Vbat2 + 2.79164;
    ...
    soc_bat3 = soc_bat3 + (current_measure/(500*3600));
    } else {
      voltage_check = 10000;
      if(Vbat3 < 3.28873){
        soc_bat3 = 15.951*Vbat3 - 44.2822;
...
//    } if (soc_bat4 < 100){
//    soc_bat4 = soc_bat4 + (2*current_measure/(3*500*3600));
//    } else {
//      voltage_check = 1;
//      if(Vbat4 < 3.17341){
//        soc_bat4 = 5.791*Vbat4 - 14.449;
